 ...
 */
export const SubscriptionAllowanceState = {
    AVAILABLE: "available",
    EXHAUSTED: "exhausted",
    UNREADABLE: "unreadable"
} as const;
export type SubscriptionAllowanceState =
    (typeof SubscriptionAllowanceState)[keyof typeof SubscriptionAllowanceState];
