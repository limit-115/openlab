import { z } from "zod";
import { AgentActivityPhase, AgentRunStatus } from "#src/agent-activity/agent-activity.const";
...
export const AgentRunIdentitySchema = z.object({
    ...
    /** The run directory's own name, which is also where its artifacts live on disk. */
