...
CREATE TABLE "investigations" (
	...
	"state" "investigation_state" DEFAULT 'RUNNING' NOT NULL,
	"state_reason" text,
...
--> statement-breakpoint
ALTER TABLE "agent_runs" ADD CONSTRAINT "agent_runs_investigation_id_investigations_id_fk" FOREIGN KEY ("investigation_id") REFERENCES "public"."investigations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "assumptions" ADD CONSTRAINT "assumptions_investigation_id_investigations_id_fk" FOREIGN KEY ("investigation_id") REFERENCES "public"."investigations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "capability_requests" ADD CONSTRAINT "capability_requests_investigation_id_investigations_id_fk" FOREIGN KEY ("investigation_id") REFERENCES "public"."investigations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "events" ADD CONSTRAINT "events_investigation_id_investigations_id_fk" FOREIGN KEY ("investigation_id") REFERENCES "public"."investigations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "runtime_checkpoints" ADD CONSTRAINT "runtime_checkpoints_investigation_id_investigations_id_fk" FOREIGN KEY ("investigation_id") REFERENCES "public"."investigations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "verdicts" ADD CONSTRAINT "verdicts_investigation_id_investigations_id_fk" FOREIGN KEY ("investigation_id") REFERENCES "public"."investigations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "agent_runs_investigation_status_idx" ON "agent_runs" USING btree ("investigation_id","status");--> statement-breakpoint
CREATE INDEX "agent_runs_assumption_idx" ON "agent_runs" USING btree ("assumption_id");--> statement-breakpoint
CREATE INDEX "assumptions_investigation_status_idx" ON "assumptions" USING btree ("investigation_id","status");--> statement-breakpoint
CREATE INDEX "capability_requests_investigation_status_idx" ON "capability_requests" USING btree ("investigation_id","status");--> statement-breakpoint
CREATE UNIQUE INDEX "events_id_unique" ON "events" USING btree ("id");--> statement-breakpoint
CREATE INDEX "events_investigation_sequence_idx" ON "events" USING btree ("investigation_id","sequence");--> statement-breakpoint
CREATE INDEX "findings_investigation_status_idx" ON "findings" USING btree ("investigation_id","status");--> statement-breakpoint
CREATE INDEX "labs_state_idx" ON "investigations" USING btree ("state");--> statement-breakpoint
