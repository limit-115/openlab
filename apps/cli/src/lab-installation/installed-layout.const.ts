 ...
 * it. So the versions live under a home of their own, and `NIGHTLAB_HOME` stays what it says it is.
 */
 ...
 *
 * `NIGHTLAB_INSTALL_DIR` is asked first because it is the one an operator sets on purpose;
 * `XDG_BIN_HOME` is the specification's answer for where a user's own executables belong.
 */
export const InstallEnvironment = {
    INSTALL_DIRECTORY: "NIGHTLAB_INSTALL_DIR",
