import type { AllowanceWindow } from "@openlab/protocol/harness-allowance/harness-allowance.types";
...
} from "#src/allowance-panel/spend-cap-meter.const";
...
interface SpendCapMeterProps {
    ...
    cap: number;
    /** The lab is passing this harness over on this window, by the caps it has actually been given. */
    withheld: boolean;
