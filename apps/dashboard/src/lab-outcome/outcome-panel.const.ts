...
export const OUTCOME_SUMMARY = "max-w-[1100px] text-sm leading-[1.55] text-[#d3dad6]" as const;

export const OUTCOME_LIMITATIONS = "mt-4" as const;

export const OUTCOME_LIMITATIONS_HEADING = "mb-[7px] text-sm uppercase text-fg-faint" as const;

export const OUTCOME_LIMITATIONS_LIST =
    "grid list-disc gap-[5px] pl-[18px] text-sm text-fg-muted" as const;
...
export const ARTIFACT_PATH = "text-sm text-fg-muted" as const;
