...
export const TABLE_HEAD_CELL =
    "border-b border-line bg-[rgba(8,12,10,0.28)] px-[14px] py-[11px] text-left text-[8px] font-[700] uppercase tracking-[0.08em] text-fg-faint" as const;
...
export const CLAIM_IDENTIFIER = "mt-1 font-mono text-[8px] text-fg-faint" as const;

export const EVIDENCE_COUNT_POSITIVE =
    "inline-flex min-w-[26px] font-mono text-[9px] text-green" as const;

export const EVIDENCE_COUNT_NEGATIVE =
    "inline-flex min-w-[26px] font-mono text-[9px] text-red" as const;
