...
/** A list of items. Every child must be an `Item` rendered as a list item via `asChild`. */
...
const itemVariants = cva(
    "group/item flex w-full flex-wrap items-center rounded-2xl border text-sm transition-colors duration-100 outline-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 [a]:transition-colors [a]:hover:bg-muted",
    {
        variants: {
            variant: {
...
function ItemTitle({ className, ...props }: React.ComponentProps<"div">) {
    return (
        <div
            ...
            className={cn(
                "flex w-fit items-center gap-2 text-sm leading-snug font-medium break-words underline-offset-4",
                className
            )}
            {...props}
        />
