...
export const BRANCH_CARD_TITLE =
    "overflow-hidden text-ellipsis whitespace-nowrap text-[12px] font-[650]" as const;

export const BRANCH_CARD_APPROACH =
    "mt-1 overflow-hidden text-ellipsis whitespace-nowrap text-[10px] text-fg-muted" as const;
...
export const BRANCH_PROGRESS = "my-3 text-[11px] leading-[1.5] text-[#c0c9c4]" as const;
