...
export const PANEL_TITLE = "mt-px text-sm font-[680]" as const;

export const PANEL_ACTION = "flex-none" as const;

export const PANEL_BODY = "p-4" as const;

export const EYEBROW = "text-sm font-[720] uppercase text-fg-faint" as const;

export const PANEL_UPDATED_AT = "text-sm text-fg-faint max-[620px]:hidden" as const;

export const PANEL_COUNT_BADGE =
    "rounded-full border border-line bg-surface-soft px-[7px] py-1 text-sm text-fg-faint" as const;

export const PANEL_COUNT_BADGE_ALERT =
    "rounded-full border border-amber/22 bg-amber/11 px-[7px] py-1 text-sm text-amber" as const;
